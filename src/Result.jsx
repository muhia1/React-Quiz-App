...
const Result = ({answers,restartTest}) => {
    ...
    const mistakes = questions.filter((_,index) => answers[index] === 0).map((question) =>({
        ...
        correctAnswer: question.option.find((opt) => opt.isCorrect).text
    }))
  ...
  return (
    <div className='flex flex-col gap -6 text-center'>
        ...
        {mistakes.length > 0 && (
            <div className='mt-4 taxt-left'>
                <h3 className='mb-3 text-xl font-semibold text-red-600'>Questions you missed:</h3>
